...
export function ReadmeForm() {
  const [form, setForm] = useState({
    projectName: "", description: "", techStack: "", features: "", installation: "", author: "",
  });
  ...
  return (
    <div className="space-y-6">
      <div className="grid md:grid-cols-2 gap-4">
        {[
          { label: "Project Name *", key: "projectName", placeholder: "e.g. Sensei AI Career Coach" },
          { label: "Author / GitHub Username", key: "author", placeholder: "e.g. kaushikyash2910" },
          { label: "Tech Stack *", key: "techStack", placeholder: "e.g. Next.js, Tailwind, Prisma, Groq AI" },
          { label: "Installation Steps", key: "installation", placeholder: "e.g. npm install, add .env, npx prisma migrate" },
      ...
      <Button onClick={handleGenerate} disabled={loading} className="w-full">
        {loading ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" />Generating README...</> : "Generate README.md"}
      </Button>
